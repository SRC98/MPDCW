...
public class GetRWDataMaps extends AsyncTask<ArrayList<String>, Void, ArrayList<String>> {
    private MapsActivity activity;
    private String CurrentIncidenturl;
    private XmlPullParserFactory xmlFactoryObject;

    public GetRWDataMaps(MapsActivity activity, String CurrentIncidenturl) {
            ...
            while (event != XmlPullParser.END_DOCUMENT) {
                if (event == XmlPullParser.START_TAG) {
                    if (myParser.getName().equalsIgnoreCase("item")) {
                        ...
                        if (insideItem)
                            result.add("Roadworks:  " + myParser.nextText());
    ...
    protected void onPostExecute(ArrayList<String> result) {
        ...
        activity.callBackRWDataMaps(result);
    }

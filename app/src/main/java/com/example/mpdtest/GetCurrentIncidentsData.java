...
public class GetCurrentIncidentsData extends AsyncTask<ArrayList<String>, Void, ArrayList<String>> {
    private CurrentIncidentFragment activity;
    private String CurrentIncidenturl;
    private XmlPullParserFactory xmlFactoryObject;
    private ProgressDialog prgDialog;

    public GetCurrentIncidentsData(CurrentIncidentFragment activity, String CurrentIncidenturl) {
    ...
    protected void onPreExecute() {
        ...
        prgDialog.setTitle("Getting Current Incidents from XML");
    ...
    protected void onPostExecute(ArrayList<String> result) {
        ...
        prgDialog.dismiss();
        activity.callBackDataCI(result);
    }
